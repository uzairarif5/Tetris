...
public class TwoPlayerGame {
    ...
    public static JPanel createGamePanel(StartWindow sw) {
        ...
        secondPanel.setBorder(BorderFactory.createLineBorder(Color.black,4));
        GridBagConstraints gbcLabel2 = new GridBagConstraints();
        gbcLabel.insets = new Insets(0, 0, 0, 0);
        sw.otherPixel = new JLabel[GameplayCode.totalRows-4][GameplayCode.totalCols];
        for(curPixelR = 0; curPixelR< GameplayCode.totalRows-4; curPixelR++) {
            for(curPixelC = 0; curPixelC< GameplayCode.totalCols; curPixelC++) {
                JLabel pixel = new JLabel();
                pixel.setBorder(BorderFactory.createLineBorder(Color.black,1));
                pixel.setOpaque(true);
                sw.otherPixel[curPixelR][curPixelC] = pixel;
                gbcLabel2.gridx = curPixelC;
                gbcLabel2.gridy = curPixelR+1;
                gbcLabel2.ipadx = 15;
                gbcLabel2.ipady = 15;
                gbcLabel2.gridwidth = 1;
                gbcLabel2.gridheight = 1;
                secondPanel.add(pixel,gbcLabel2);
            }
        }
        gbc.gridx = 3;
        gbc.gridy = 1;
        ...
        sw.secondScore = new JLabel(" Score: 0");
        sw.secondScore.setBackground(Color.DARK_GRAY);
        sw.secondScore.setBorder(BorderFactory.createMatteBorder(0, 0, 3, 0, Color.black));
        sw.secondScore.setOpaque(true);
        sw.secondScore.setPreferredSize(new Dimension(GameplayCode.totalCols*17,30));
        sw.secondScore.setForeground(Color.white);
        sw.secondScore.setFont(new Font("Arial", Font.PLAIN, 20));
        gbcLabel2.gridx = 0;
        gbcLabel2.gridy = 0;
        gbcLabel2.ipadx = 0;
        gbcLabel2.ipady = 0;
        gbcLabel2.gridwidth = GameplayCode.totalCols+1;
        gbcLabel2.gridheight = 1;
        secondPanel.add(sw.secondScore,gbcLabel2);
        gbc.anchor = GridBagConstraints.CENTER;
        gamePanel.add(secondPanel,gbc);
